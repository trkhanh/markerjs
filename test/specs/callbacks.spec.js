...
describe("Callbacks", function () {
  ...
  /**
   * Test functioning of the marker callbacks.
   * Procedure:
   *  [1] Load fixture.
   *  [2] Create selection range.
   *  [3] Initialie highlighter with defined callbacks.
   *  [4] Highlight range. If params .onRemoveHighlight is defined the remove all range to trigger callback.
   *  [5] Check text content created highlight
   * @param params
